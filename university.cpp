...
void University::add_instance(Params params)
{
    ...
    Instance* n_instance = new Instance(course, params.at(1), utils::today);
...
void University::sign_up_on_course(Params params)
{
    ...
    if ((! courses_.at(params.at(0))->get_instance(params.at(1))->find_student(accounts_.at(std::stoi(params.at(2)))))) {
        std::cout << ALREADY_REGISTERED << std::endl;
        return;
    }

    courses_.at(params.at(0))->get_instance(params.at(1))->add_student_to_instance(accounts_.at(std::stoi(params.at(2))), utils::today);
...
void University::complete_course(Params params)
{
    ...
    int current_student = std::stoi(params.at(2));
    std::string c_instance = params.at(1);
    Course* c_course = courses_.at(params.at(0));
    accounts_.at(current_student)->complete_course(c_course, c_instance);
}
...
void University::print_study_state(Params params)
{
    ...
    accounts_.at(stoi(params.at(0)))->print_study_state();
}
...
void University::print_completed(Params params)
{
    ...
    accounts_.at(stoi(params.at(0)))->print_completed();
}
